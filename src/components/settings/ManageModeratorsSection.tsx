...
function ManageModeratorsSection() {
  ...
  const permissions = [
    { id: "all", name: "Full Access", icon: Shield, color: "text-red-600" },
    {
      id: "orders",
  ...
  const roles = [
    { value: "admin", label: "Admin", description: "Admin Desc" },
    { value: "moderator", label: "Moderator", description: "Moderator Desc" },
    { value: "support", label: "Support", description: "Support Desc" },
  ];
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      >
                        {`Role Names ${moderator.role.toLowerCase()}`}
                      </span>
                    </div>
