      ...
      <div className="flex bg-white dark:bg-black/80 rounded-2xl m-1   flex-1 flex-col gap-4 p-4 pt-0">
        ...
        <div className="flex justify-between items-center">
          <Title
            title={t("Products")}
            Subtitle={t(
              "The most important part of our platform where you can add products in a way that increases the purchase and conversion rate.  When creating or editing a product, look at the advanced settings that will increase your sales."
            )}
            className="text-3xl"
            classNamee=""
          />
