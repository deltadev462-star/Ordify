...
const CategoryCard: React.FC<CategoryCardProps> = memo(({
  ...
  return (
    <div
      ...
      className={`
        ...
        ${category.image?.path ? '' : `bg-gradient-to-br ${category.color}`}
        backdrop-blur-sm
      ...
      style={{
        ...(category.image?.path && {
          backgroundImage: `url(${category.image.path})`,
    ...
    >
      ...
      <div className="relative p-6">
        ...
        <div className="flex justify-between items-start mb-4">
          <div className={`
            p-3 rounded-xl ${category.image?.path ? 'bg-white/80 dark:bg-black/60' : 'bg-white/50 dark:bg-black/20'}
          ...
          <div className="flex items-center gap-2">
            <Badge
              ...
              className={`
                ...
                ${category.image?.path ? 'backdrop-blur-sm' : ''}
              `}
            >
        ...
        <div className={`
          ...
          bg-gradient-to-t ${
            category.image?.path
              ? 'from-black/60 dark:from-black/80 to-transparent'
              : 'from-black/20 dark:from-black/40 to-transparent'
          }
        ...
        `}>
          <div className="flex gap-2">
            <Button
              size="sm"
              onClick={handleEdit}
              className="flex-1 rounded-xl bg-white/90 dark:bg-black/50 backdrop-blur-sm hover:bg-white dark:hover:bg-black/70 text-foreground shadow-lg"
            >
            ...
            <Button
              ...
              onClick={handleView}
              variant="secondary"
              className="flex-1 rounded-xl backdrop-blur-sm shadow-lg"
            >
  ...
  return (
    ...
    prevProps.category.image?.path === nextProps.category.image?.path &&
